#==============================
Function Get-ManagedServiceReport {  
<#
    .SYNOPSIS
    Examines system machines and gathers active Service Accounts for the report.

    .DESCRIPTION
    This script that gathers the active config from 
    all Related Win OS servers in the local domain. Then will return 
    a report listing all domain accounts used as service logon account.
